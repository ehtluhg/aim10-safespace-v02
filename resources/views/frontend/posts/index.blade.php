    ...
    <div class="hero-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 class="wow fadeInUp" data-wow-delay="1.4s"><span style="color: gray;">By</span> <a href="{{ url('viewProfile/' . $postitem->user->id) }}" style="text-decoration: none; color: #fff;">{{ $postitem->user->name }}</a></h4>
